...
public class Shopmenu2 : MonoBehaviour
{
    ...
    private const string Hatkey = "Weapon";
    ...
    void Start()
    {
       // PlayerPrefs.DeleteAll();
        ...
        currentIndex = PlayerPrefs.GetInt("Weapon", 0);
    ...
    void UpdateUI()
    {
        ...
        if (currentModel.isUnlocked)
        {
            ...
            else
            {
                ...
                PlayerPrefs.SetInt("Weapon", currentIndex);
            }
        }
        else
        {
    ...
    public void BuyOrPickModel()
    {
        ...
        if (currentModel.isUnlocked && !currentModel.isSelected)
        {
            ...
            PlayerPrefs.SetInt(Hatkey, currentIndex); // Seçili player'ý PlayerPrefs ile kaydet
            UpdateUI();
        }
    ...
    void LoadModelUnlockStatus()
    {
        ...
        int selectedPlayerIndex = PlayerPrefs.GetInt(Hatkey, 0);
